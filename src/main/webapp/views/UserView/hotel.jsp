...
<!-- Mirrored from preview.colorlib.com/theme/direngine/hotel.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 18:03:32 GMT -->
...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active"><a href="/Web_Assignment/user/hotels" class="nav-link">Hotels</a></li>
	...
	<div class="hero-wrap js-fullheight"
		style="background-image: url('/Web_Assignment/views/UserView/images/bg_5.jpg');">
						...
						<div class="block-23 mb-3">
							<ul>
								...
								<li><a href="#"><span class="icon icon-envelope"></span><span class="text"><span
												class="__cf_email__"
												data-cfemail="bbd2d5ddd4fbc2d4cec9dfd4d6dad2d595d8d4d6">[email&#160;protected]</span></span></a>
								</li>
							</ul>
						</div>
					</div>
