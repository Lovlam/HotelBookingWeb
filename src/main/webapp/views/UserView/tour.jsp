...
<!-- Mirrored from preview.colorlib.com/theme/direngine/tour.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 18:03:31 GMT -->
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="/Web_Assignment/user/tour" class="nav-link">Tour</a></li>
          ...
          <li class="nav-item"><a href="/Web_Assignment/user/contact/Web_Assignment/user/index" class="nav-link">Contact</a></li>
  ...
  <div class="hero-wrap js-fullheight" style="background-image: url('/Web_Assignment/views/UserView/images/bg_3.jpg');">
      ...
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
        ...
        <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
          <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a
                href="index.html">Home</a></span> <span>Tour</span></p>
            ...
            <div class="block-23 mb-3">
              <ul>
                ...
                <li><a href="#"><span class="icon icon-envelope"></span><span class="text"><span class="__cf_email__"
                        data-cfemail="87eee9e1e8c7fee8f2f5e3e8eae6eee9a9e4e8ea">[email&#160;protected]</span></span></a>
                </li>
              </ul>
            </div>
          </div>
...
<!--   <div id="ftco-loader" class="show fullscreen"><svg class="circular" width="48px" height="48px">
  ...
  <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317"
    ...
    data-cf-beacon='{"rayId":"866723292f145ff0","b":1,"version":"2024.2.4","token":"cd0b4b3a733644fc843ef0b185f98241"}'
    crossorigin="anonymous"></script>
</body>

<!-- Mirrored from preview.colorlib.com/theme/direngine/tour.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 18:03:32 GMT -->
