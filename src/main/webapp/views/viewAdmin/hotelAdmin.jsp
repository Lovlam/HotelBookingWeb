...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item active" href="/Web_Assignment/admin/hotel"><i class='app-menu__icon bx bx-id-card'></i>
          <span class="app-menu__label">Quản lý khách sạn</span></a></li>
